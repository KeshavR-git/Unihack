  ...
  const qAndAs = [
    {
      question: 'What is it',
      answer: ' is a contagious respiratory illness caused by the SARS-CoV-2 virus. It first appeared in Wuhan, China, in December 2019 and has since spread globally, causing a pandemic.'
    },
    {
      question: 'What are the symptoms?',
      answer: 'The most common symptoms of  include fever, cough, and shortness of breath. Other symptoms may include fatigue, body aches, headache, loss of taste or smell, sore throat, and congestion or runny nose.'
    },
    {
      question: 'How does  spread?',
      answer: ' is primarily spread through respiratory droplets that are produced when an infected person talks, coughs, or sneezes. The virus can also spread by touching a surface or object contaminated with the virus and then touching your mouth, nose, or eyes.'
    },
    {
      question: 'How can I protect myself',
      answer: 'You can protect yourself from  by wearing a mask, practicing physical distancing, washing your hands frequently with soap and water, avoiding large gatherings, and staying home when you are sick.'
    },
    {
      question: 'Is there a vaccine',
      answer: 'Yes, there are several vaccines that have been authorized for emergency use to prevent . These vaccines have been shown to be safe and effective at preventing  and its complications.'
    },
    {
      question: 'What should I do if I think I have it',
      answer: 'If you think you have , you should stay home and self-isolate. You can get tested for  to confirm whether or not you have the virus. If you have symptoms of  or have been in close contact with someone who has , you should get tested.'
    },
    {
      question: 'How long does it take to recover',
      answer: 'The recovery time for  varies depending on the severity of the illness. Most people with mild to moderate  can recover at home without hospitalization. However, some people with severe  may require hospitalization and intensive care. It can take several weeks or months to fully recover from .'
    },
    {
      question: 'What is the difference between  and the flu?',
      answer: ' and the flu are both contagious respiratory illnesses, but they are caused by different viruses.  is caused by the SARS-CoV-2 virus, while the flu is caused by influenza viruses.  is generally more contagious and can cause more severe illness than the flu. The symptoms of  and the flu can be similar, but there are some differences. For example,  can cause loss of taste or smell, which is not a common symptom of the flu.'
    },
    {
      question: 'Can  be transmitted through food?',
      answer: 'According to the Centers for Disease Control and Prevention (CDC), there is currently no evidence to suggest that  can be transmitted through food or food packaging. The virus primarily spreads through respiratory droplets produced when an infected person talks, coughs, or sneezes.'
    },
    {
    ...
    {
      question: 'What are the symptoms',
      answer: 'The symptoms of  can vary from person to person, but common symptoms include fever or chills, cough, shortness of breath or difficulty breathing, fatigue, muscle or body aches, headache, new loss of taste or smell, sore throat, congestion or runny nose, nausea or vomiting, and diarrhea.'
    },
    {
      question: 'How can I protect myself and others',
      answer: 'To protect yourself and others from , you should wash your hands often with soap and water, wear a mask in public settings, stay at least 6 feet away from others who do not live with you, avoid crowds and poorly ventilated spaces, cover your coughs and sneezes with a tissue or your elbow, clean and disinfect frequently touched surfaces, and monitor your health for symptoms of .'
    },
    {
    ...
    },
    {
      ...
      answer: 'Contact tracing is the process of identifying and notifying people who have been in close contact with someone who has tested positive for . This helps to prevent the spread of the virus by identifying people who may have been exposed and encouraging them to self-quarantine or get tested. Contact tracing is typically done by public health officials, who work with infected individuals to identify their close contacts and notify them of their potential exposure.'
    },
    {
      question: 'What is the  vaccine?',
      answer: 'The  vaccine is a vaccine that is designed to prevent . There are several different types of  vaccines available, but all of them work by teaching the immune system how to recognize and fight the virus that causes . The  vaccines have been shown to be safe and effective in clinical trials, and are an important tool in the fight against the  pandemic.'
    },
    {
      question: 'What is ?',
      answer: ' is an infectious disease caused by the SARS-CoV-2 virus. It was first identified in Wuhan, China in December 2019, and has since become a global pandemic. The virus spreads primarily through respiratory droplets when an infected person talks, coughs, or sneezes, and can cause a range of symptoms from mild to severe.'
    },
    {
      question: 'Who is at risk of severe illness from ?',
      answer: 'Older adults and people with underlying medical conditions, such as heart disease, lung disease, or diabetes, are at increased risk of severe illness from . However, people of all ages can become seriously ill from the virus, and it is important to take precautions to protect yourself and others.'
    },
    {
      question: 'What should I do if I think I have ?',
      answer: 'If you think you have , you should stay home and self-isolate to avoid spreading the virus to others. You should also contact your healthcare provider for advice on what to do next, as they may recommend that you get tested for the virus. If you are experiencing severe symptoms, such as difficulty breathing, you should seek medical attention immediately.'
    },
    {
      question: 'How is  treated?',
      answer: 'There is currently no specific treatment for , but there are treatments available that can help to manage symptoms and support the body’s natural defenses. Treatment may include rest, fluids, and over-the-counter medications for pain and fever. In more severe cases, hospitalization may be required.'
    },
    {
      question: 'Can I get  from touching a surface?',
      answer: 'It is possible to get  from touching a surface that has the virus on it and then touching your face, but this is not thought to be the main way that the virus spreads. The virus spreads primarily through respiratory droplets when an infected person talks, coughs, or sneezes, so it is important to wear a mask and practice social distancing to reduce the risk of getting or spreading the virus.'
    },
    {
